...
class Field(object):
    ...
    def __init__(self, field_identifier):
        self.field_identifier = field_identifier
    
    def __str__(self):
        return f"{self.field_identifier}"
...
class SelectField(Field):
    ...
    def __init__(self, field_name, field_identifier=None, agg_func=None):
        if field_identifier:
            # an identifier was supplied
            super().__init__(field_identifier)
        elif agg_func:
    ...
    def __str__(self):
        ...
        if self.agg_func:
            if self.field_identifier != f"{self.agg_func}({self.field_name})":
                return f"{self.agg_func}({self.field_name}) AS {self.field_identifier}"
            return f"{self.agg_func}({self.field_name})"

        # Simple expression:
        if self.field_identifier != self.field_name:
            return f"{self.field_name} AS {self.field_identifier}"
...
class OrderField(Field):
    ...
    def __init__(self, field_identifier, order="asc"):
        super().__init__(field_identifier)
        self.order = order

    def __str__(self):
        return f"{self.field_identifier} {self.order.upper()}"
